    ...
    return (<>
        ...
        >
            ...
            <div style={{ padding: '20px' }}>
                ...
                <div style={{ display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'flex-end', padding: '0px 22px 0px 0px', marginTop: '30px' }}>
                    ...
                    <div>
                        <Button
                            ...
                            style={{ float: "right", width: '93px', height: '44px' }}
                            onClick={(event) => {
                                if (publishStore.reqslots.length !== 0) {
                                    publishArrangement();
